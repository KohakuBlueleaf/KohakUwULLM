"""Microbatch sweep: 8192 x 32 in fp16, fused MoE, 1F1B.

Matches the shape the eager routed path measured at 192.4k tok/s.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_08192x32_fp16.py
"""
