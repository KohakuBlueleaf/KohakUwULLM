"""Microbatch sweep: 16384 tokens x 16 microbatches = 262144 per step.

The TIPO-era shape, which OOMed on the corpus at ctx_max 2048. Sixty steps, no
checkpoint, no preview. See configs/lm/general/general_1b_400k.py for the real run.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_16384x16.py
"""
