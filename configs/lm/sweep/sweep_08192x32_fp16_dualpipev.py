"""Microbatch sweep: 8192 x 32 in fp16, fused MoE, DualPipeV.

Two stages per rank over eight chunks; the 1F1B arm measured 276.0k tok/s.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_08192x32_fp16_dualpipev.py
"""
...
SAMPLE_INTERVAL = 0
CONSOLE_INTERVAL = 20
NAME = "sweep-08192x32-fp16-dualpipev"
