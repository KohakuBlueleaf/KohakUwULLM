"""Microbatch sweep: 16384 x 16 in fp16, fused MoE, 1F1B.

The shape that OOMed on the eager routed path. Sixty steps, no checkpoint.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_16384x16_fp16.py
"""
