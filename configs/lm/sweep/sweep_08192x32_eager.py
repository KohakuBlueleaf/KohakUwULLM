"""Microbatch sweep: 8192 x 32 in fp16, eager MoE, 1F1B.

The control arm for the fused path at a shape both fit.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_08192x32_eager.py
"""
...
ARCH_OVERRIDES = {
    ...
    "grad_ckpt": False,
    "mxfp8": False,
    "moe_mlp_kwargs": {"expert_path": "eager"},
}
AUX_LOSS_WEIGHT = 0.0
