"""Microbatch sweep: 4096 x 64 in fp16, fused MoE, 1F1B.

Brackets the optimum below 8192, where the 1F1B bubble is 4.5%.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_04096x64_fp16.py
"""
