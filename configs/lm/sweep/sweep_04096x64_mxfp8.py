"""Microbatch sweep: 4096 x 64 with MXFP8.

Narrow microbatch, smallest 1F1B bubble of the ladder, smallest per-expert
GEMM. Sixty steps, no checkpoint, no preview.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_04096x64_mxfp8.py
"""
