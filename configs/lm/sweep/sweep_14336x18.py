"""Microbatch sweep: 14336 tokens x 18 microbatches = 258048 per step.

Sixty steps, no checkpoint, no preview. See configs/lm/general/general_1b_400k.py for
the real run.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_14336x18.py
"""
