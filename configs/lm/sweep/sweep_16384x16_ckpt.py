"""Microbatch sweep: 16384 x 16 with activation checkpointing.

The widest microbatch, bought back with recompute when it will not otherwise
fit. Sixty steps, no checkpoint, no preview.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_16384x16_ckpt.py
"""
