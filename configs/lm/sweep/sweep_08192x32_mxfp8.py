"""Microbatch sweep: 8192 x 32 with MXFP8 routed experts.

The shape the 400k run uses, plus the MXFP8 swap it was missing. Sixty steps,
no checkpoint, no preview.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_08192x32_mxfp8.py
"""
