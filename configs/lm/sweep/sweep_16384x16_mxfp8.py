"""Microbatch sweep: 16384 x 16 with MXFP8, no activation checkpointing.

Wider microbatch, larger 1F1B bubble; MXFP8 is what makes it fit. Sixty steps,
no checkpoint, no preview.

    kogine run scripts/train/lm_pipe.py --config configs/lm/sweep/sweep_16384x16_mxfp8.py
"""
